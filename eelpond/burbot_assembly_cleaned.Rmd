...
ssh -i ~/.ssh/mandykey.pem -l ubuntu ec2-54-188-49-118.us-west-2.compute.amazonaws.com
...
# output: C:91.9%[S:36.9%,D:55.0%],F:4.8%,M:3.3%,n:4584 Time to compute: ~6 hours 
# WOW, way better than before (only 80% complete BUSCO's before). 

```


INFO    Results:
INFO    C:91.9%[S:36.9%,D:55.0%],F:4.8%,M:3.3%,n:4584
INFO    4212 Complete BUSCOs (C)
INFO    1692 Complete and single-copy BUSCOs (S)
INFO    2520 Complete and duplicated BUSCOs (D)
INFO    221 Fragmented BUSCOs (F)
INFO    151 Missing BUSCOs (M)
INFO    4584 Total BUSCO groups searched
INFO    BUSCO analysis done. Total running time: 23495.177022218704 seconds
INFO    Results written in /home/ubuntu/data/4_Busco/run_burbot2_busco_fish/
